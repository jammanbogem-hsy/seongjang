...
export const SEED_SLIDES = [
  {
    ...
    illustration: '/assets/illustrations/cat-ideation.png', answersRevealed: true, commentsEnabled: true,
  },
  {
    ...
    illustration: '/assets/illustrations/cat-lobby.png', answersRevealed: true, commentsEnabled: false,
  },
  {
    ...
    illustration: '/assets/illustrations/cat-timer.png', answersRevealed: true, commentsEnabled: true,
  },
  {
    ...
    illustration: '/assets/illustrations/cat-submission.png', answersRevealed: false, commentsEnabled: false,
  },
] as const
...
export const SUBMISSION_SEEDS = [
  ['participant-02', '흐름이', '흩어진 해커톤의 순간을 하나의 이야기로 잇는 진행 도우미', '단계별 질문, 라이브 진행, 회고 기록을 한 흐름에 모아 처음 온 참가자도 길을 잃지 않게 합니다.', 'https://example.com/flowy', 'https://github.com/example/flowy', ['진행', '온보딩', '아카이빙'], '기능보다 다음 행동이 명확한 질문 한 줄이 더 중요하다는 것을 배웠습니다.', '/assets/illustrations/cat-lobby.png'],
  ['participant-05', '조용한 마이크', '모든 사람의 아이디어가 같은 크기로 보이는 익명 브레인스토밍 보드', '발언 순서나 목소리 크기에 관계없이 개인 답변을 모으고 공개 시점에 한꺼번에 펼칩니다.', 'https://example.com/quiet-mic', '', ['포용성', '브레인스토밍'], '익명성과 맥락 사이의 균형을 참가자가 직접 선택하도록 설계하고 싶습니다.', '/assets/illustrations/cat-ideation.png'],
  ['participant-08', 'README 정원사', '만드는 동안 남긴 메모로 프로젝트 소개를 키워주는 작은 편집자', '질문에 답한 기록과 링크를 조합해 전시 카드, 회고, README를 동시에 만듭니다.', 'https://example.com/readme-gardener', 'https://github.com/example/readme-gardener', ['README', '개인제출', '전시'], '완성 후 문서를 쓰게 하지 말고 만드는 과정에서 자연스럽게 모아야 했습니다.', '/assets/illustrations/cat-submission.png'],
  ['participant-11', '같은 페이지', '진행자의 리듬을 모든 화면에 전달하는 동기화 슬라이드', '슬라이드, 타이머, 공개 상태를 실시간으로 맞춰 현장과 온라인 참가자가 같은 장면을 봅니다.', 'https://example.com/same-page', 'https://github.com/example/same-page', ['실시간', '슬라이드', '타이머'], '시간 자체보다 시작·멈춤·재개의 기준을 한 곳에 두는 것이 핵심이었습니다.', '/assets/illustrations/cat-timer.png'],
  ['participant-14', '행사 릴레이', '한 행사에서 얻은 배움을 다음 행사로 넘기는 포터블 데이터 키트', '개인 정보를 덜어낸 결과를 JSON, CSV, Markdown으로 내보내 다른 도구가 이어받게 합니다.', '', 'https://github.com/example/event-relay', ['데이터', '내보내기', '재사용'], '내보내기 형식이 여러 개여도 공개 원본은 하나여야 신뢰할 수 있습니다.', '/assets/illustrations/cat-exhibition.png'],
  ['participant-17', '백 명의 온도', '100명 안의 몰입과 막힘을 한눈에 읽는 운영 대시보드', '참여, 응답, 제출 신호를 간결하게 모아 운영자가 개입할 순간을 놓치지 않게 합니다.', 'https://example.com/room-temperature', '', ['운영', '대시보드', '100명'], '숫자를 많이 보여주기보다 지금 도움이 필요한 사람을 드러내는 데 집중했습니다.', '/assets/illustrations/cat-exhibition.png'],
] as const
